...
namespace hiterror {
    ...
    /* todo: move to circular buffer struct or something */
    ...
    inline statistics::Ema ema = statistics::Ema();
    inline statistics::Ema smoothed_ema = statistics::Ema();
